    ...
    <div v-if="user">
        ...
        <section class="px-4 pb-8">
                ...
                <div class="flex items-start justify-between">
                    ...
                    <div>
                        <router-link
                            ...
                            class="text-sm bg-sky-400 hover:bg-sky-500 text-white transition rounded-full px-4 py-2 max-w-max">
                                Modifica
                        </router-link>
            ...
            <div class="text-sm mt-5">
                ...
                <p class="pb-5 flex items-center space-x-1 text-slate-400 dark:text-slate-200">
