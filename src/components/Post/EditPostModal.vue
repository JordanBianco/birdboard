<template>
    <div>
        ...
        <!-- Modal -->
        <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 md:w-[440px] w-full">
            <form
                @submit.prevent="updatePost()"
                class="text-sm bg-white dark:bg-zinc-700 rounded-xl p-5 shadow-lg w-full md:w-[440px]">
                    <textarea
